      ...
      <div className="bg-[#FFF9F0] rounded-none max-w-lg w-full shadow-2xl border-2 border-[#214C6A] overflow-hidden flex flex-col max-h-[92vh] text-[#222E3A]">
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="bg-[#F6E1C6]/70 rounded-none p-3.5 border border-[#214C6A]/20 text-center shadow-xs relative">
            ...
            <div className="text-3xl sm:text-4xl font-black text-[#BC6343] font-['Outfit',sans-serif] mt-0.5">
              {formatCOP(total)}
            </div>
            {discount > 0 && (
            ...
            <div className="space-y-3 bg-[#F6E1C6]/50 p-3.5 rounded-none border border-[#214C6A]/20">
              ...
              <div className={`p-3 rounded-none border transition-all ${
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-2xl font-black font-['Outfit',sans-serif]">
                    {isInsufficientCash ? (
        ...
        <div className="p-3.5 bg-[#FFF9F0] border-t-2 border-[#214C6A] flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex-1 py-3 px-5 rounded-none bg-[#BC6343] hover:bg-[#964937] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-black flex items-center justify-center gap-2 shadow-md active:scale-95 transition-all cursor-pointer border border-[#EB9D52]/40"
          >
            <CheckCircle className="w-5 h-5 text-[#EB9D52]" />
            <span>Finalizar Venta • {formatCOP(total)}</span>
          </button>
        </div>
      </div>
    </div>
