                ...
                <>
                  ...
                  <div className="bg-[#214C6A] text-white p-4 rounded-none border border-[#214C6A] flex flex-wrap items-center justify-between gap-3 shadow-xs">
                    <div>
                      ...
                      <h4 className="text-base font-bold font-['Outfit',sans-serif] mt-0.5">
                        Cajero: <strong className="text-[#EB9D52]">{currentShift.cashierName}</strong>
                      </h4>
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-2xl sm:text-3xl font-black text-[#EB9D52] font-['Outfit',sans-serif]">
