      ...
      <div className="bg-[#FFF9F0] rounded-none max-w-2xl w-full shadow-2xl border-2 border-[#214C6A] overflow-hidden flex flex-col max-h-[88vh] text-[#222E3A]">
        ...
        <div className="p-4 sm:p-5 bg-[#214C6A] border-b border-[#214C6A] text-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-extrabold font-['Outfit',sans-serif] text-white">
          ...
          <div className="p-4 sm:p-5 flex-1 overflow-y-auto space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
              ...
              <div className="bg-[#F6E1C6]/60 p-3 rounded-none border border-[#214C6A]/20 text-center">
                ...
                <span className="text-base sm:text-lg font-black text-[#BC6343] font-['Outfit',sans-serif]">
              ...
              <div className="bg-[#F6E1C6]/60 p-3 rounded-none border border-[#214C6A]/20 text-center">
                ...
                <span className="text-base sm:text-lg font-black text-[#214C6A] font-['Outfit',sans-serif]">
              ...
              <div className="bg-[#F6E1C6]/60 p-3 rounded-none border border-[#214C6A]/20 text-center col-span-2 sm:col-span-1">
                ...
                <span className="text-base sm:text-lg font-black text-emerald-800 font-['Outfit',sans-serif]">
            ...
            {totalClients > 0 && (
              <div className="bg-[#F6E1C6]/40 p-3 rounded-none border border-[#214C6A]/20 flex items-center justify-between gap-3 text-xs">
                ...
                <span className="text-sm sm:text-base font-black text-[#214C6A] font-['Outfit',sans-serif] shrink-0">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2.5">
                      <div className="text-right">
                        <span className="text-xs sm:text-sm font-black text-[#BC6343] font-['Outfit',sans-serif] block">
                          {formatCOP(tx.total)}
                        </span>
                        {tx.discount > 0 && (
        ...
        {activeTab === 'cuadre' && (
          <div className="p-4 sm:p-5 flex-1 overflow-y-auto space-y-4">
            <div className="bg-[#214C6A] p-4 rounded-none border border-[#214C6A] text-center text-white">
              ...
              <div className="text-3xl font-black text-white font-['Outfit',sans-serif] mt-1">
                {formatCOP(totalRevenue)}
              </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="bg-[#FFF9F0] p-3.5 rounded-none border border-emerald-300 flex items-center justify-between">
                ...
                <span className="text-base font-black text-emerald-800 font-['Outfit',sans-serif]">
              ...
              <div className="bg-[#FFF9F0] p-3.5 rounded-none border border-[#214C6A]/20 flex items-center justify-between">
                ...
                <span className="text-base font-black text-[#BC6343] font-['Outfit',sans-serif]">
              ...
              <div className="bg-[#FFF9F0] p-3.5 rounded-none border border-[#214C6A]/20 flex items-center justify-between">
                ...
                <span className="text-base font-black text-[#214C6A] font-['Outfit',sans-serif]">
          ...
          <div className="p-4 sm:p-5 flex-1 overflow-y-auto space-y-3">
            <div className="bg-[#F6E1C6]/70 p-3.5 rounded-none border border-[#214C6A]/20 flex items-center justify-between">
              <div>
                ...
                <div className="text-2xl font-black text-[#BC6343] font-['Outfit',sans-serif]">
            ...
            {fiadosList.length === 0 ? (
              ...
              fiadosList.map((tx) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <span className="text-sm font-black text-[#BC6343] font-['Outfit',sans-serif] block">
                      {formatCOP(tx.total)}
                    </span>
                    <button
                      onClick={() => {
