...
export const InteractiveProductCard: React.FC<InteractiveProductCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "group relative w-full select-none cursor-pointer overflow-hidden rounded-none bg-[#FFF9F0] shadow-sm transition-all duration-200 hover:shadow-xl border border-[#214C6A]/20 hover:border-[#BC6343]",
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#222E3A]/95 via-[#222E3A]/55 to-[#214C6A]/25 rounded-none transition-opacity duration-300 group-hover:via-[#222E3A]/65" />
      ...
      >
        ...
        <div className="flex items-start justify-between gap-2 rounded-none border border-white/20 bg-[#214C6A]/85 p-2.5 sm:p-3 backdrop-blur-md shadow-md transition-all duration-200 group-hover:bg-[#214C6A]/95 group-hover:border-[#EB9D52]/60">
          <div className="flex flex-col min-w-0 pr-1 flex-1">
            ...
            <h3 className="text-xs sm:text-sm md:text-base font-extrabold text-[#FFF9F0] leading-snug line-clamp-2 drop-shadow-sm font-['Outfit',sans-serif]">
              {title}
            </h3>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              <div className="rounded-none bg-[#BC6343] px-2.5 py-1 shadow-md border border-[#EB9D52]/40 w-fit backdrop-blur-md">
                <span className="text-[9px] font-bold text-[#F6E1C6] mr-1">COP</span>
                <span className="text-xs sm:text-sm md:text-base font-black text-[#FFF9F0] tracking-tight font-['Outfit',sans-serif]">
                  {price}
                </span>
              </div>
              {originalPrice && (
